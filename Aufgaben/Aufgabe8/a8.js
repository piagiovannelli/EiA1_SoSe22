var sound = [
    new Audio("./BilderSounds/DrumPad_A.mp3"),
    new Audio("./BilderSounds/DrumPad_C.mp3"),
    new Audio("./BilderSounds/DrumPad_F.mp3"),
    new Audio("./BilderSounds/DrumPad_G.mp3"),
    new Audio("./BilderSounds/DrumPad_hihat.mp3"),
    new Audio("./BilderSounds/DrumPad_kick.mp3"),
    new Audio("./BilderSounds/DrumPad_snare.mp3"),
    new Audio("./BilderSounds/DrumPad_laugh-1.mp3"),
