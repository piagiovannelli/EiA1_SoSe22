...
interface Satz { //Definition von spanischem und deutschem Satz als strings
...
function shuffleArray(array): void { //Zufallsmischung
...
window.addEventListener("load", function () {
    ...
    document.getElementById("leicht").onclick = function () { // Wenn man auf leicht klickt ->
    ...
    function wortKlick(wort) { //wenn ich auf ein Wort klicke gehen die Wörter vom spanischen Satz in den Übersetzungsbereich unter "richtige Wörter"
